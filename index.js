...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: When nestedFunction() is invoked it returns the string from the variable internal. nestedFunction 's "function is to return the string from the outer function."
...
const zooAnimals = [
  ...
  */
  ...
  function consume(meal1, meal2, callBack){
    return callBack(meal1, meal2);
  }
